CREATE SCHEMA projeto17 AUTHORIZATION jhenifer;


-- Criação da tabela
CREATE TABLE projeto17.lancamentosdsacontabeis (
    id INT PRIMARY KEY,
...
CREATE OR REPLACE PROCEDURE projeto17.carregar_dados_contabeis()
LANGUAGE plpgsql
AS $$
DECLARE
    i INT;
...
BEGIN
    FOR i IN 1..1000 LOOP
        ...
        INSERT INTO projeto17.lancamentosdsacontabeis (
            id, 
            data_lancamento, 
            conta_debito, 
            conta_credito, 
...
-- Executa a SP
CALL projeto17.carregar_dados_contabeis();

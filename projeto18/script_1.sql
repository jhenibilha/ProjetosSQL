...
CREATE SCHEMA projeto18 AUTHORIZATION jhenifer;


-- Criação da tabela
CREATE TABLE projeto18.campanha_mkt (
    id SERIAL,
...
CREATE OR REPLACE PROCEDURE projeto18.inserir_dados_campanha_mkt()
LANGUAGE plpgsql
AS $$
DECLARE
    i INT := 1;
...
BEGIN
    LOOP
        ...
        -- Inserir registro
        INSERT INTO projeto18.campanha_mkt

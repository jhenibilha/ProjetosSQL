...
CREATE SCHEMA projeto6 AUTHORIZATION jhenifer;


-- Cria a tabela
CREATE TABLE projeto6.pacientes_menopausa (
    classe VARCHAR(255),
    idade VARCHAR(255),
...
INSERT INTO projeto6.pacientes_menopausa (classe, idade, menopausa, tamanho_tumor, inv_nodes, node_caps, deg_malig, seio, quadrante, irradiando) VALUES

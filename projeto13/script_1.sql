CREATE SCHEMA projeto13 AUTHORIZATION jhenifer;

-- Criação da tabela Clientes
CREATE TABLE IF NOT EXISTS projeto13.clientesABC (
...
CREATE TABLE IF NOT EXISTS projeto13.produtosABC (
...
CREATE TABLE IF NOT EXISTS projeto13.pedidosABC (
    id_pedido INT PRIMARY KEY,
    id_produto INT REFERENCES projeto13.produtosABC(id_prod),
    data_pedido DATE NULL,
    valor_pedido DECIMAL(10, 2) NULL,
    id_cliente INT REFERENCES projeto13.clientesABC(id_cli)
);


-- Carrega os dados na tabela de Clientes
INSERT INTO projeto13.clientesABC (id_cli, nome_cliente, tipo_cliente, cidade_cliente, estado_cliente) 
...
INSERT INTO projeto13.produtosABC (id_prod, nome_produto, nome_formacao) 
...
INSERT INTO projeto13.pedidosABC (id_pedido, id_produto, data_pedido, valor_pedido, id_cliente) 
